...
contract xyToken is Rlp{
    ...
    address public AMM_provider;
    
    constructor() public payable {
        address(this).transfer(1000000000);
        AMM_provider = msg.sender;
    ...
    function makeChild() internal returns (address addr) {
        assembly{
            ...
            //Bytecode of creating a GST2 child contract
    ...
    function buy(uint256 amount) external payable returns(uint256) {
        ...
        if ((head - tail - _ownedSupply) < amount){
        ...
        _ownedSupply += amount;
        internalTransfer(AMM_provider,msg.sender,amount);
